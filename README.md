...
# &#x20; ✓  researcher\_01  →  llama-3-8b   $0.001    11ms

# &#x20; ✓  analyst\_04     →  gpt-4o       $0.047   780ms

# &#x20; ✓  writer\_02      →  mistral-7b   $0.002    43ms

# &#x20; ✗  crawler\_07     →  BLOCKED      $0.000  loop@13

# &#x20; ✓  researcher\_14  →  llama-3-8b   $0.001     9ms
...
# &#x20;   hard\_limit\_usd=5.00,     # Hard stop — never exceed this per run

# &#x20;   warn\_at\_usd=2.00,        # Alert when approaching limit

# &#x20;   auto\_route=True,          # Auto-route cheap tasks to Llama/Groq

# &#x20;   block\_loops=True,         # Kill recursive agent loops instantly

# &#x20;   log\_to\_db=True            # Save full history to runcost.db
